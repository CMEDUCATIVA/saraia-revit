...
namespace Bibim.Core
{
    ...
    ///   - Categorize as ? safe / ?? version-specific / ? deprecated
    ...
    public class ApiInspectorService
    {
        ...
        public string FormatReport(ApiInspectionReport report)
        {
            ...
            // Summary counts
            sb.AppendLine($"Summary: ? {report.SafeCount} safe, ?? {report.VersionSpecificCount} version-specific, ? {report.DeprecatedCount} deprecated");
