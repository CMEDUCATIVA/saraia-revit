        ...
        <header style={{
          ...
          <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 'var(--space-sm)' }}>
            <SettingsPanel
              ...
              deepseekConfigured={chat.deepseekConfigured}
              deepseekMasked={chat.deepseekMasked}
              onSaveDeepSeekKey={chat.saveDeepSeekApiKey}
              deepseekSaveResult={chat.deepseekSaveResult}
