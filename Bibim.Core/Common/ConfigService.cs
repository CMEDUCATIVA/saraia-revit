...
namespace Bibim.Core
{
    ...
    public static class ConfigService
    {
        ...
        private static RagConfig LoadRagConfig()
        {
            ...
            string anthropicApiKey = null, openAiApiKey = null, deepSeekApiKey = null, geminiApiKey = null, localApiKey = null;
            ...
            try
            {
                ...
                if (obj["api_keys"] is JObject apiKeys)
                {
                    ...
                    deepSeekApiKey = apiKeys["deepseek_api_key"]?.ToString();
                ...
                string envDeepSeek = Environment.GetEnvironmentVariable("DEEPSEEK_API_KEY");
                if (!string.IsNullOrEmpty(envDeepSeek)) deepSeekApiKey = envDeepSeek;
        ...
        public static string GetApiKeyForProvider(string providerName, RagConfig cfg = null)
        {
            ...
            switch (providerName)
            {
                ...
                case "deepseek":  return cfg.DeepSeekApiKey;
        ...
        public static bool HasKeyForProvider(string providerName)
        {
            ...
            return !string.IsNullOrWhiteSpace(key) && key != "CLAUDE_API_KEY_HERE"
                && key != "OPENAI_API_KEY_HERE" && key != "DEEPSEEK_API_KEY_HERE"
        ...
        public static void SaveApiKeyForProvider(string providerName, string apiKey)
        {
            ...
            switch (providerName)
            {
                ...
                case "openai":
                    ...
                    break;
                case "deepseek":
                    apiKeys["deepseek_api_key"] = trimmedKey;
                    break;
                case "gemini":
