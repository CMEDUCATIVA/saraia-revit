    ...
    public class BibimApp : IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            try
            {
                ...
                // ExternalEvent.Create must run in a valid context — OnStartup qualifies.
                ...
                // 3b. Local HTTP control API — lets an external orchestrator (Kun skill)
                ...
                try
                {
                    ...
                    application.RegisterDockablePane(panelId, "SaraIA",
                ...
                Logger.Log("BibimApp", $"SaraIA v{AppVersion} started successfully");
        ...
        {
            Logger.Log("BibimApp", $"SaraIA v{AppVersion} shutting down");
            try
            {
        ...
        private void CreateRibbonUI(UIControlledApplication app)
        {
            ...
            var panel = app.CreateRibbonPanel(tabName, "SaraIA");

            string btnText = "SaraIA";
