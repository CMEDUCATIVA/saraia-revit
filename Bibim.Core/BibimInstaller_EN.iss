...
begin
  ...
  begin
    MsgBox(
      ...
      'Please close all Revit 2024/2025/2026 instances before installing Bibim.',
      mbError,
      MB_OK);
  end;
end;
...
begin
  ...
  Content :=
    ...
    '    <VendorDescription>Bibim - AI-powered Revit code generation</VendorDescription>' + #13#10 +
    '  </AddIn>' + #13#10 +
...
begin
  ...
  begin
    ...
    MsgBox(
      'Bibim v{#MyAppVersion} has been installed.' + #13#10 + #13#10 +
